...
mkswap /dev/sda3
swapon /dev/sda3
mkfs.btrfs -f -L btrfsraid -m raid10 -d raid10 /dev/sda4 /dev/sdb4 /dev/sdc4 /dev/sdd4
...
echo hostname="service_s" > /etc/conf.d/hostname
...
#emerge net-misc/dhcpcd && rc-update add dhcpcd default - отключил dhcpd
...
dracut -f --kver 6.1.46-gentoo-dist
