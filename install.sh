...
echo -e "\e[31m--- Создать пользователя: useradd <name> ---\e[0m"
echo -e "\e[31m--- Создать пароль пользователя: passwd <name> ---\e[0m"
echo -e "\e[31m--- Добавить права суперпользователя аналогично root: visudo ---\e[0m"
