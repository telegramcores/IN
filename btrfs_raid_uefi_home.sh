...
mount -o defaults,autodefrag,noatime,space_cache,compress=zstd:3,subvol=@ /dev/sda4 /mnt/gentoo
mkdir -p /mnt/gentoo/{home,.snapshots,var,share}
mount -o autodefrag,noatime,space_cache,compress=zstd:3,subvol=@home /dev/sda4 /mnt/gentoo/home
mount -o autodefrag,noatime,space_cache,compress=zstd:3,subvol=@var  /dev/sda4 /mnt/gentoo/var
mount -o autodefrag,noatime,space_cache,compress=zstd:3,subvol=@snapshots  /dev/sda4 /mnt/gentoo/.snapshots
mount -o autodefrag,noatime,space_cache,compress=zstd:3,subvol=@share /dev/sda4 /mnt/gentoo/share
...
blkid /dev/sda4 | awk '{print $3" / btrfs defaults,noatime,autodefrag,space_cache,compress=zstd:3,subvol=@  0 0"}' >> /etc/fstab
blkid /dev/sda4 | awk '{print $3" /home btrfs noatime,autodefrag,space_cache,compress=zstd:3,subvol=@home  0 0"}' >> /etc/fstab
blkid /dev/sda4 | awk '{print $3" /var btrfs noatime,autodefrag,space_cache,compress=zstd:3,subvol=@var  0 0"}' >> /etc/fstab
blkid /dev/sda4 | awk '{print $3" /.snapshots btrfs noatime,autodefrag,space_cache,compress=zstd:3,subvol=@snapshots 0 0"}' >> /etc/fstab
blkid /dev/sda4 | awk '{print $3" /share btrfs noatime,autodefrag,space_cache,compress=zstd:3,subvol=@share  0 0"}' >> /etc/fstab
...
emerge app-eselect/eselect-repository app-portage/layman sys-process/btop sys-fs/bees
...
dracut -f --kver 6.1.24-gentoo-dist
